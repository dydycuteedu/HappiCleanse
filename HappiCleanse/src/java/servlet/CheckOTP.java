...
public class CheckOTP extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.getRequestDispatcher("pages/EnterOTP.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getSession().getAttribute("otp") == null) {
            response.sendRedirect("/HappiCleanse/error.jsp");
            return;
        }
        ...
        if (inputOtp.equals(otp)) {
            response.sendRedirect("/HappiCleanse/ChangePassword");
            return;
            
        }
        request.setAttribute("message", "Your OTP is wrong. Please input again !!!");
