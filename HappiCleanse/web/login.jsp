                        ...
                        <div class="tab-content" id="pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="pills-login" role="tabpanel"
                                ...
                                <form action="/HappiCleanse/login" method="post">
                                    ...
                                    <!--Login google-->
                                    <a style="margin-top:100px" href="https://accounts.google.com/o/oauth2/auth?scope=email profile openid&redirect_uri=http://localhost:8080/HappiCleanse/login-google&response_type=code&client_id=736597478888-lb1kurpmc507lagf345egoeto6u7ne3l.apps.googleusercontent.com&approval_prompt=force">Login With Google</a> 
                                </form>
                            </div>
