            ...
            <div class="row justify-content-center">
                <div class="col-lg-6 col-md-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="bg-light p-5 rounded">
                        <h5 class="text-center mb-4">Verify Your Identity</h5>
                        <p class="text-center mb-4">Please enter the OTP sent to your email or phone number.</p>
                        <form action="CheckOTP" method="POST">
                            <div class="form-floating mb-4">
                                <input type="text" class="form-control" id="otp" placeholder="Enter OTP" maxlength="6" name="otp">
