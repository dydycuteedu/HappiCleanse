                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="${pageContext.request.contextPath}/UsersServlet" method="post" style="display: inline;">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="checkbox" id="switch" switch="none" name="status" <c:if test="${user.status == true}">checked</c:if> />
