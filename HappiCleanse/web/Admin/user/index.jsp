                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">
                                            ...
                                            <a href="${pageContext.request.contextPath}/UsersServlet?actor=admin&action=create" id="editable-sample_new" class="btn btn-primary">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="checkbox" id="switch" switch="none" name="status" disabled
                                                                   <c:if test="${user.status == true}">checked</c:if> />
                                                                   <label for="switch" data-on-label="On" data-off-label="Off"></label>
                                                            </td>
                                                            <td>
                                                                <div class="btn-group" role="group">

                                                                    <form action="${pageContext.request.contextPath}/UsersServlet" method="get" style="display: inline;">
