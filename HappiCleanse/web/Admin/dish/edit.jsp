                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="${pageContext.request.contextPath}/DishServlet" method="post" style="display: inline;">
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="resname" id="userid" value="${dish.userID}" >
                                                </div>
                                                <label for="rolename" class="col-sm-2 col-form-label">Mã Loại Món Ăn</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="dishcatid" id="dishcategoryid" value="${dish.dishCategoryID}" >
                                                </div>
                                                <label for="rolename" class="col-sm-2 col-form-label">Tên Món Ăn</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="name" id="dname" value="${dish.name}">
                                                </div>
                                                <label for="rolename" class="col-sm-2 col-form-label">Mô tả món ăn</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="ddes" id="description" value="${dish.description}" >
                                                </div>
                                                <label for="rolename" class="col-sm-2 col-form-label">Hình ảnh</label>
                                                <div class="col-sm-10">
                                                    <input class="form-control" type="text" name="imgurl" id="imgurl" value="${dish.imgURL}" >
                                                </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="checkbox" id="switch1" name="status1" switch="status" <c:if test="${dish.status == true}">checked</c:if> />
                                                    <label for="switch1" data-on-label="On" data-off-label="Off"></label>
                                                </div>
                                                <label for="status" class="col-sm-2 col-form-label">Đang bán</label>
                                                <div class="col-sm-10">
                                                    <input type="checkbox" id="switch2" name="status2" switch="status" <c:if test="${dish.exist == true}">checked</c:if> />
