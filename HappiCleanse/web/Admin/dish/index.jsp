                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h4 >Quản Lí Món Ăn</h4>
                                            <a href="${pageContext.request.contextPath}/DishServlet?actor=admin&action=create" id="editable-sample_new" class="btn btn-primary">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <c:forEach var="dish" items="${list}">
                                                    <tr>
                                                        <td>${dish.dishID}</td>
                                                        <td><img class="rounded-circle header-profile-user" src="${dish.imgURL}" alt="anh do an"/> ${dish.name}</td>
