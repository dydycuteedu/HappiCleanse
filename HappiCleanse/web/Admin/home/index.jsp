...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Data Tables | Happi Cleanse</title>
    ...
    <body data-topbar="dark">
                                ...
                                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">HappiCleanse</a></li>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <div class="d-flex">
                                            <div class="flex-grow-1">
                                                <p class="text-truncate font-size-14 mb-2">Service using</p>
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="card">
                                    <div class="card-body pb-0">
                                        ...
                                        <h4 class="card-title mb-4">Service statistic</h4>
        ...
        <!-- apexcharts -->
        <script src="${pageContext.request.contextPath}/Admin\assets/libs/apexcharts/apexcharts.min.js"></script>

        <!-- jquery.vectormap map -->
        <script src="${pageContext.request.contextPath}/Admin\assets/libs/admin-resources/jquery.vectormap/jquery-jvectormap-1.2.2.min.js"></script>
        <script src="${pageContext.request.contextPath}/Admin\assets/libs/admin-resources/jquery.vectormap/maps/jquery-jvectormap-us-merc-en.js"></script>
        ...
        <script src="${pageContext.request.contextPath}/Admin\assets/js/pages/dashboard.init.js"></script>
