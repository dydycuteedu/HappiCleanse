                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h4 >Quản Lí Danh Mục Món Ăn</h4>
                                            <a href="${pageContext.request.contextPath}/DishCategoryServlet?actor=admin&action=create" id="editable-sample_new" class="btn btn-primary">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody>
                                                <c:forEach var="dishcategory" items="${list}">
                                                    <tr>
                                                        <td>${dishcategory.dishCategoryID}</td>
                                                        <td>${dishcategory.name}</td>
                                                        <td>
                                                            <input type="checkbox" id="switch" switch="none" name="status" disabled
                                                                   <c:if test="${dishcategory.status == true}">checked</c:if> />
                                                                   <label for="switch" data-on-label="On" data-off-label="Off"></label>
                                                            </td>
                                                            <td>
                                                                <div class="btn-group" role="group">

                                                                    <form action="${pageContext.request.contextPath}/DishCategoryServlet" method="GET" style="display: inline;">
