                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="profile-details">
                                            <ul>
                                                <li><strong>Mã Món Ăn:</strong> ${dish.dishID}</li>
                                                <li><strong>Mã Người Dùng:</strong> ${dish.userID}</li>
                                                <li><strong>Mã Loại Món Ăn:</strong> ${dish.dishCategoryID}</li>
                                                <li><strong>Tên Món Ăn:</strong> ${dish.name}</li>
                                                <li><strong>Mô Tả Món Ăn:</strong> ${dish.description}</li>
                                                <li><strong>Hình Ảnh Món Ăn:</strong> ${dish.imgURL}</li>
                                                <li><strong>Giá Món Ăn:</strong> ${dish.price}</li>
                                                <li><strong>Trạng thái:</strong> ${dish.exist}</li>
                                                <li><strong>Hành Động:</strong> ${dish.status}</li>
                                            </ul>
                                        </div>
                                        <div class="mb-0">
                                            <div>
